...
import net.komunan.komunantw.repository.converter.TweetMediasConverter
import net.komunan.komunantw.repository.converter.TweetUrlsConverter
...
@TypeConverters(TweetUrlsConverter::class, TweetMediasConverter::class)
